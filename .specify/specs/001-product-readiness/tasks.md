...
| T009 | [TEST] Prove the interactive wizard maps every choice to a validated init option and propagates child failure | test | `.trellis/tests/wizard.test.mjs` | FR-005, VAL-001, EDGE-005 | T006 | [P] |
| T010 | Remove fake tiers and make the wizard select stacks and optional integrations directly | impl | `.trellis/scripts/wizard.mjs` | FR-005, FR-006, VAL-001 | T009 | [P] |
...
| T046 | Add generated-project templates and reduce root env guidance to actual Trellis integration variables | impl | `.trellis/templates/project/README.md`, `.env.example`, `.trellis/templates/**` | FR-010, FR-011, VAL-004 | T045 | — |
...
| T053 | Run formatter-free syntax checks, self-tests, `npm ci`, `npm run check`, package dry-run, scaffold smoke, and full Bounds validation | verify | repository | FR-001–FR-011, SC-001–SC-003, VAL-001–VAL-004, INV-001–INV-005 | T051, T052 | — |
