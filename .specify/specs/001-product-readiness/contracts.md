...
| `trellis handoffs` | `list` or `validate` | none | Lists or validates the static registry | FR-001, VAL-001 |
...
| `enabled_integrations` | string array | subset of `graphify`, `bounds`, `phoenix` | FR-006, SC-003 |
